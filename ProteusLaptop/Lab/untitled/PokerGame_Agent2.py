...
from deuces import *
from Log import *
from Client_2 import *



def evaluation(fraction):

    global iMsg,SIGNAL_ALIVE,CURRENT_HAND
    ...
    # * Separate the words by space. */
        ...
        tmp = queryOpenAction(infoAgent.CurrentHand, minimumPotAfterOpen, playersCurrentBet, playerRemainingChips)
        ...
        tmp = queryCallRaiseAction(infoAgent.CurrentHand, maximumBet, minimumAmountToRaiseTo, playersCurrentBet, playersRemainingChips)
